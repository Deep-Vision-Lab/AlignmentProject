...
from utils.model_loading import (
    load_image_model, load_text_embedder, load_char_bank_if_available,
)
...
def draw_hard_negative_case(checkpoint, sentence_idx, num_negatives,
    ...
    ax_img.set_title(
        ...
        f"\"{arabic_label(text)}\"  |  neg_mode={negative_mode}  |  cost=d3tw",
        fontsize=11, pad=6,
    )
    ax_img.axis("off")
    ...
    col_labels = ["Rank", "Transcript", "Type", "D3TW Cost", "Match"]
    table_data = []
    row_colors = []
    GREEN = "#d4efdf"
    RED   = "#fadbd8"
