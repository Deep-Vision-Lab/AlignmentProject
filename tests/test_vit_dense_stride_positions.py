...
def test_dense_stride_produces_125_tokens_from_trained_position_base():
    model = EmbeddingModel(window_size=32, stride=8, vector_size=32, device="cpu", use_flip=False, input_height=128, vit_layers=1, vit_heads=4, vit_mlp_dim=64, vit_dropout=0.0, vit_max_tokens=256, vit_position_base_tokens=63)
...
def test_dense_positions_do_not_read_untrained_table_tail():
    model = EmbeddingModel(window_size=32, stride=8, vector_size=32, device="cpu", input_height=128, vit_layers=1, vit_heads=4, vit_mlp_dim=64, vit_dropout=0.0, vit_max_tokens=256, vit_position_base_tokens=63)
