...
# Keep the expanded-real Phase-3 recipe fixed so this ablation changes only
# the no_shared image-image supervision.
...
# Keep the image-text negative recipe fixed for this ablation.
