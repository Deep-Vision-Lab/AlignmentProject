...
LOCAL_HARD_NEGATIVE_MIN_INK="${LOCAL_HARD_NEGATIVE_MIN_INK:-0.05}"
LOCAL_HARD_NEGATIVE_EVERY_N_BATCHES="${LOCAL_HARD_NEGATIVE_EVERY_N_BATCHES:-1}"
...
VALID_EVERY_N_EPOCHS="${VALID_EVERY_N_EPOCHS:-5}"
VALID_MAX_BATCHES="${VALID_MAX_BATCHES:-0}"
