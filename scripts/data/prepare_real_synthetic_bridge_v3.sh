...
MAX_PHRASE_CHARS="${MAX_PHRASE_CHARS:-6}" MAX_PHRASE_WORDS="${MAX_PHRASE_WORDS:-2}" \
SENTENCE_MIN_WORDS="${SENTENCE_MIN_WORDS:-5}" SENTENCE_MAX_WORDS="${SENTENCE_MAX_WORDS:-7}" \
MIN_SENTENCE_CHARS="${MIN_SENTENCE_CHARS:-22}" MAX_SENTENCE_CHARS="${MAX_SENTENCE_CHARS:-34}" \
