...
def main():
    args=core.parse_args(); args.min_line_fill_ratio=max(float(args.min_line_fill_ratio),0.90); args.font_size=max(56,min(int(args.font_size),64)); args.min_font_size=max(42,int(args.min_font_size)); args.max_font_size=min(64,int(args.max_font_size))
