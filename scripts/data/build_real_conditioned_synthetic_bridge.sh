...
SENTENCE_MIN_WORDS="${SENTENCE_MIN_WORDS:-8}"
SENTENCE_MAX_WORDS="${SENTENCE_MAX_WORDS:-16}"
MIN_SENTENCE_CHARS="${MIN_SENTENCE_CHARS:-36}"
MAX_SENTENCE_CHARS="${MAX_SENTENCE_CHARS:-130}"
MAX_FONT_CHUNK_WORDS="${MAX_FONT_CHUNK_WORDS:-1}"
MIN_LINE_FILL_RATIO="${MIN_LINE_FILL_RATIO:-0.75}"
MAX_FONT_SIZE="${MAX_FONT_SIZE:-88}"
