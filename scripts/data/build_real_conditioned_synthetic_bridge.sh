...
MAX_PHRASE_CHARS="${MAX_PHRASE_CHARS:-10}"
...
SENTENCE_MAX_WORDS="${SENTENCE_MAX_WORDS:-8}"
MIN_SENTENCE_CHARS="${MIN_SENTENCE_CHARS:-26}"
MAX_SENTENCE_CHARS="${MAX_SENTENCE_CHARS:-52}"
MAX_FONT_CHUNK_WORDS="${MAX_FONT_CHUNK_WORDS:-2}"
FONT_SIZE="${FONT_SIZE:-58}"
MIN_FONT_SIZE="${MIN_FONT_SIZE:-42}"
MAX_FONT_SIZE="${MAX_FONT_SIZE:-74}"
MIN_LINE_FILL_RATIO="${MIN_LINE_FILL_RATIO:-0.70}"
PADDING="${PADDING:-14}"
SEGMENT_GAP_MIN_PX="${SEGMENT_GAP_MIN_PX:-5}"
SEGMENT_GAP_MAX_PX="${SEGMENT_GAP_MAX_PX:-10}"
