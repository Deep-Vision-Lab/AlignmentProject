...
MAX_PHRASE_CHARS="${MAX_PHRASE_CHARS:-8}"
...
MAX_SENTENCE_CHARS="${MAX_SENTENCE_CHARS:-40}"
...
MIN_LINE_FILL_RATIO="${MIN_LINE_FILL_RATIO:-0.65}"
PADDING="${PADDING:-8}"
SEGMENT_GAP_MIN_PX="${SEGMENT_GAP_MIN_PX:-3}"
SEGMENT_GAP_MAX_PX="${SEGMENT_GAP_MAX_PX:-7}"
