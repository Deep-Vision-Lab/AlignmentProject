#!/usr/bin/env bash
# Submit Bridge V3 dataset generation, then automatically submit the model pipeline
# only after D0 completes successfully. No manual intervention is required.
set -euo pipefail
