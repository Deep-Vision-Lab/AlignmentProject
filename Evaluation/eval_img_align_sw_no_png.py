...
# Configure legacy/new ResNet choice before importing evaluation modules. Non-CNN
# checkpoints return None and are handled by the branch model backend below.
...
# _eval_utils historically constructed embeddingModel.EmbeddingModel directly.
# Redirect that constructor to this checkout's canonical architecture branch while
# preserving the evaluator's checkpoint/config reconstruction arguments.
...
# ``sw_runner.evaluate_sample`` resolves this function from its own module globals.
